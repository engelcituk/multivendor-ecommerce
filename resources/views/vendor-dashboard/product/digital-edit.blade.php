        ...
        <form action="" class="product-form">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="card mt-3" id="product-images">
                        <div class="card-header">
                            <h3 class="card-title">Archivos del producto</h3>
                        </div>
                        <div class="card-body">
                            <div class="col-md-12">
                                <div class="mb-3">
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <select name="status" class="form-control" id="">
                                        ...
                                        <option @selected($product->status == 'pending') value="pending">Pendiente</option>
                                    </select>
...
@push('scripts')
    ...
    <script>
        ...
        const fileUploader = new Dropzone("#fileUploader", {
            ...
            <div class="dz-percentage"><span class="progress-text">0</span>% subido</div>
