...
return [
    ...
    'attributes'             => [
        ...
        'attribute_type'           => 'tipo del atributo',
        'brand'                    => 'marca',
        'categories'               => 'categorías',
        'charge'                   => 'cargo',
        'code'                     => 'código',
        'document_scan_copy'       => 'copia digital del documento',
        ...
        'store'                    => 'tienda',
        'sub_title'                => 'subtítulo',
        'usage_limit_per_coupon'   => 'límite de uso por cupón',
        'usage_limit_per_customer' => 'límite de uso por cliente',
        'variant_price'            => 'precio de la variante',
        'variant_stock_status'     => 'inventario de la variante',
        'withdraw_amount'          => 'importe del retiro',
        'withdraw_method_id'       => 'método de retiro',
    ],
];
